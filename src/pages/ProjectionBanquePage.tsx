...
export default function ProjectionBanquePage() {
  ...
  const [financingType, setFinancingType] = useState<FinancingType>("AMORTIZING");
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={financingType} onValueChange={(v) => setFinancingType(v as FinancingType)}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="AMORTIZING">Prêt amortissable</SelectItem>
                  <SelectItem value="BULLET">Prêt in fine</SelectItem>
                  <SelectItem value="LEASE">Crédit-bail matériel</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
